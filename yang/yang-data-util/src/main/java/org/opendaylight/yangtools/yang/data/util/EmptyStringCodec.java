...
final class EmptyStringCodec extends LeafSimpleValueStringCodec<Void, EmptyTypeDefinition> implements
        EmptyCodec<String> {

    protected EmptyStringCodec(final EmptyTypeDefinition typeDef) {
