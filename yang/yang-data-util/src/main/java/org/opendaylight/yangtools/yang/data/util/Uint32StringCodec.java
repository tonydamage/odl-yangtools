...
final class Uint32StringCodec extends LeafSimpleValueStringCodec<Long, UnsignedIntegerTypeDefinition>
        implements Uint32Codec<String> {

    protected Uint32StringCodec(UnsignedIntegerTypeDefinition typeDef) {
